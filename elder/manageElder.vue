...
export default {
  ...
  data() {
    ...
    return {
      ...
      //  tableData:[
      //   {id: "1", name: "hmx1", gender: "男"},
      //   {id: "2", name: "hmx", gender: "男"},
      //   {id: "3", name: "hmx", gender: "男"},
      //   {id: "4", name: "hmx", gender: "男"},
      //   {id: "5", name: "hmx", gender: "男"},
      // ],
      // realTable: [
      //   {id: "1", name: "hmx1", gender: "男"},
      //   {id: "2", name: "hmx", gender: "男"},
