        ...
        <div class="innerPage">
          ...
          >
            <el-form-item label="name:" prop="name" >
              <el-input v-model="addcForm.name" style="width:65%; margin-right:220px"></el-input>
            </el-form-item>

            <el-form-item label="telephone:" prop="tel">
              <el-select v-model="query.country" placeholder="country" class="country">
            ...
            <el-form-item label="emerge person" prop="guardian_name" style="width:55% ">
              <el-input v-model="addcForm.guardian_name"></el-input>
            </el-form-item>

            <el-form-item label="birthday" prop="birthday">
              <el-input v-model="addcForm.birthday"></el-input>
            </el-form-item>
...
<el-input v-model="addcForm.x" style="position:absolute; top:340px; left:680px;width:100px;margin-left:180px; margin-bottom:10px;"></el-input>
<el-button
                    class="button3"
                    type="danger"
                    @click="sendPath"
                    style="position:absolute; top:540px; left:680px;width:100px;margin-left:180px; margin-bottom:10px;"
                    >发请求</el-button
                  >
            <el-form-item>
              <el-row>
  ...
  methods: {
    ...
    sendPath() {
      this.$axios({
            ...
            method: "post",
            data: {
              path: "rtmp://192.144.218.105/live/"+this.addcForm.x+"_1",
            },
        ...
        if (valid) {
          this.$axios({
            ...
            data: {
              ...
              birthday: this.addcForm.birthday,
              guardian_name: this.addcForm.guardian_name,
              guardian_phone: "17801020390",
